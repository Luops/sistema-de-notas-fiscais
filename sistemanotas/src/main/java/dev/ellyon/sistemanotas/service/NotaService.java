...
public interface NotaService {
    ...
    NotaResponseDTO marcarComoPagaSemNota(Long notaId, Authentication authentication); // Marcar nota como paga sem emissão
    ...
    NotaResponseDTO findByNumero(String numero, Authentication authentication); // Buscar nota por número e empresa
    ...
    List<NotaListResponseDTO> findByCreatedAtBetween(LocalDateTime dataInicio, LocalDateTime dataFim); // Buscar notas por intervalo de datas de criacao
    ...
    List<NotaListResponseDTO> findByFilters(String periodo, String status, String tipoDeDat); // Buscar notas por filtros combinados (período, status, tipo de data)
}
